...
<div class="ml-5 mt-3">
<h1 class="font-bold">Frequently Asked Questions (FAQ) </h1> <br>

<h2 class="font-semibold">1. How do I place an order? </h2>

To place an order, browse our products, select the item you want, choose the desired quantity, and click “Add to Cart.” Once ready, proceed to checkout and follow the instructions to complete your purchase.<br>
<br>
<h2 class="font-semibold">2. What payment methods do you accept? </h2>

We accept secure online payments through the payment methods displayed at checkout. All transactions are processed through trusted third-party payment providers.<br>
<br>
<h2 class="font-semibold">3. Can I cancel or modify my order? </h2>

Orders can only be canceled or modified before they are shipped. Please contact us as soon as possible if you need to make changes.<br>
<br>
<h2 class="font-semibold">4. How long does shipping take? </h2>

Shipping times vary depending on your location. Estimated delivery times are provided at checkout. Delays may occur due to circumstances beyond our control.<br>
<br>
<h2 class="font-semibold">5. How can I track my order? </h2>

Once your order is shipped, you will receive a confirmation email with tracking information (if available).<br>
<br>
<h2 class="font-semibold">6. What is your return policy? </h2>

We accept returns within the specified return period, provided the item is unused and in its original packaging. Please refer to our Return & Refund Policy for full details.<br>
<br>
<h2 class="font-semibold">7. What should I do if I receive a damaged or incorrect item? </h2>

Please contact us within 48 hours of receiving the item and provide photos of the issue. We will assist you with a replacement or refund.<br>
<br>
<h2 class="font-semibold">8. Do I need to create an account to place an order? </h2>

No, you can check out as a guest. However, creating an account allows you to track orders and manage your information more easily.<br>
<br>
<h2 class="font-semibold">9. How do I contact customer support? </h2>

<h4>You can reach us through:</h4><br>

Email: [medaminehajjy@gmail.com]<br>
Phone: [212774947907]<br>
Contact form on our website<br>
<br>
<h2 class="font-semibold">10. Is my personal information secure? </h2>

Yes. We implement security measures to protect your personal information and use secure payment gateways for transactions.<br>
</div>   
</main>
