...
<div class="ml-5 mt-3">
<h1 class="font-bold">Terms of Service </h1> <br>

Last Updated: [18/02/2026]<br>

Welcome to [AminWorks]. By accessing or using our website, you agree to be bound by these Terms of Service. Please read them carefully.<br>
<br>
<h2 class="font-semibold">1. Use of the Website</h2>

By using this website, you confirm that you are at least 18 years old or accessing the site under the supervision of a parent or legal guardian. You agree to use the website only for lawful purposes and in accordance with these terms.<br>
<br>
<h2 class="font-semibold">2. Products and Pricing </h2>

All products listed on our website are subject to availability. We reserve the right to modify or discontinue products at any time without prior notice. Prices are subject to change without notice. We make every effort to ensure product descriptions and pricing are accurate, but errors may occur.<br>
<br>
<h2 class="font-semibold">3. Orders and Payments </h2>

By placing an order, you agree to provide accurate and complete information. We reserve the right to refuse or cancel any order for any reason, including suspected fraud or payment issues.<br>

All payments must be made through the approved payment methods provided on our website.<br>
<br>
<h2 class="font-semibold">4. Shipping and Delivery </h2>

Shipping times are estimates and may vary depending on location and other factors. We are not responsible for delays caused by shipping carriers or events beyond our control.<br>
<br>
<h2 class="font-semibold">5. Returns and Refunds </h2>

We accept returns in accordance with our Return Policy. Products must be returned in their original condition within the specified return period. Refunds will be processed after inspection and approval.<br>
<br>
<h2 class="font-semibold">6. Intellectual Property </h2>

All content on this website, including text, images, logos, and designs, is the property of [Your Store Name] and is protected by applicable intellectual property laws. You may not copy, reproduce, or distribute any content without permission.<br>
<br>
<h2 class="font-semibold">7. Limitation of Liability </h2>

We are not liable for any indirect, incidental, or consequential damages resulting from the use of our website or products. Use of our website is at your own risk.<br>
<br>
<h2 class="font-semibold">8. Changes to Terms </h2>

We reserve the right to update or modify these Terms of Service at any time. Changes will be effective immediately upon posting on the website.<br>
<br>
<h2 class="font-semibold">9. Contact Information- </h2>

If you have any questions about these Terms of Service, please contact us at:<br>

Email: [medaminehajjy]<br>
Phone: [212774947907]<br>
Address: [Fes]<br>
</div>
    </main>
